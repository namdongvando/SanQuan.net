...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 20, 2017 at 05:41 AM
...
('Option_DiaChi', 0, 'Địa Chỉ Công Ty', '', '{"type":"TEXT","title":"Địa Chỉ Công Ty"}'),
('Option_DonViChuQuan', 0, 'Sang Team', '', '{"type":"TEXT","title":"Đơn Vị Chủ Quản"}'),
('Option_HoTroDangTinM', 0, 'Hỗ trợ tư vấn, chụp hình đăng tin miễn phí:', '', '{"type":"TEXT","title":"Ho Tro Dang Tin Mien Phi"}'),
('Option_Icon', 1, 'logo/logoComVn.png', '', '{"type":"IMG","title":"Icon Trang Web"}'),
...
('Option_MST', 0, '235647889', '', '{"type":"TEXT","title":"Mã Số Thuế"}'),
...
('Option_SDTLienHe', 0, '1234567990', '', '{"type":"TEXT","title":"Số Điện Thoại Liên Hệ"}'),
...
(11, 'quảng cáo trang chủ trái', '', 'quangcao/qc2.jpg', '#', '', 2, 0),
(12, 'quảng cáo trang chủ', '', 'quangcao/qc3.jpg', '#', '', 2, 0),
(13, 'Sang Quán', '', 'quangcao/qc222.jpg', '#', '', 2, 0),
...
--
ALTER TABLE `sangnhanh_quancao`
  MODIFY `MaQuanCao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
--
