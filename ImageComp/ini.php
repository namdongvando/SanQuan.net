    ...
    function layHinh($avata, $w, $h, $CapNha = FALSE) {
        ...
        if (file_exists($url)) {
            if (getimagesize($url)) {
                ...
                $KiemTraHinh = $ThuMuc . $__TenHinh . "_{$h}x{$w}.{$__MoRong}";
                if ($CapNha) {
                    return $ThuMuc . $this->create_thumb($TenHinh, $w, $h, $ThuMuc, $__TenHinh, 1.7);
                }
