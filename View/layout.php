    ...
    function layoutMenuCom($_Controller, $_Param) {
        ...
        <div class="container" >
            <div class="dropdown">
                ...
                <div class="dropdown-menu"  style="background-color: #18baa5;" >
                ...
                <a href="<?php echo BASE_DIR ?>dangtin" class="btn pull-right" style="border-radius: 4px;font-weight: bold;padding: 3px 15px;margin-left: 10px;"  >Đăng tin
                    <i class="fa fa-upload" ></i>
                </a>
                <?php
                if ($_SESSION[KhachHang]) {
                    ?> 
                    <a href="<?php echo BASE_DIR ?>taikhoan/dangxuat" class="btn pull-right" style="border-radius: 4px;font-weight: bold;padding: 3px 15px;"  >Đăng Xuất</a>
                    <?php
                } else {
                    ?> 
                    <a href="<?php echo BASE_DIR ?>taikhoan/dangnhap" class="btn pull-right" style="border-radius: 4px;font-weight: bold;padding: 3px 15px;"  >Đăng Nhập</a>
                    <?php
                }
                ?>
            </div>
...
DANHMUCKHAC;
    ...
    function layouthead() {
        ...
        <link rel="stylesheet" href="<?php echo BASE_DIR ?>public/home/css/style.css">
        <link href="<?php echo BASE_DIR ?>public/home/css/form-dangnhap.css" rel="stylesheet" type="text/css"/>
        <script src="<?php echo BASE_DIR ?>public/home/js/jquery-1.11.3.min.js"></script> 
        <?php
    }
