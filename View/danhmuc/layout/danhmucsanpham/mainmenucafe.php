            ...
            <ul class="nav navbar-nav"  >
                <li >
                    <a href="<?php echo BASE_DIR ?>" >
                        <img src="{LogoNet}" style="height: 50px;" title="{Title}" > 
                    </a>
                </li>
                <li >
                    <a  href="<?php echo BASE_DIR ?>">
                        <i style="background-color: #0e78bc;padding: 10px;color: #fff;font-size: 18px;border-radius: 100%; " class="fa fa-home" ></i>
                    </a>
                </li>
                <?php
